...
export const PLANS = {
  ...
  starter_monthly: {
    ...
    priceUsd:    11,
    kpLimit:     20,
    models:      ['claude-haiku-4', 'claude-sonnet-4', 'gpt-4o-mini', 'gemini-flash'],
    features:    ['20 КП/месяц', 'Claude Haiku + Sonnet', 'Экспорт TXT', 'История КП'],
  ...
  pro_monthly: {
    ...
    features:    ['Безлимит КП', 'Все 6 ИИ-моделей', 'Экспорт DOCX + PDF', 'История КП', 'Автовыбор модели'],
    popular:     true,
  ...
  starter_annual: {
    ...
    kpLimit:     20,
    models:      ['claude-haiku-4', 'claude-sonnet-4', 'gpt-4o-mini', 'gemini-flash'],
    features:    ['20 КП/месяц', 'Claude Haiku + Sonnet', 'Экспорт TXT', 'История КП', 'Скидка 20%'],
